<template>
        ...
        <Cards>
          <template #title>
            <div class="ninjadash-card-title-wrap">
              <span class="ninjadash-card-title-text"> <h1>Top Performers</h1> </span> <!-- Updated the heading here -->
            </div>
          </template>
          <!-- <template #button>
  ...
  import { BorderLessHeading, TableDefaultStyle } from "@/view/styled";
  import tableData from "@/demoData/table-data.json";
  
  const BestSeller = defineComponent({
    name: "TopPerformers", // You can also update the component name if needed
    components: {
      Cards,
      BorderLessHeading,
      TableDefaultStyle,
            ...
            return {
              ...
              sellerName: (
                <div className="ninjadash-info-element align-center-v">
                  <div className="ninjadash-info-element__media"></div>
