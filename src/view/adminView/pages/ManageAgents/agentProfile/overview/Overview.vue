    ...
    <a-row :gutter="25">
        ...
        <sdCards headless>
          <EChartCard>
            <div class="card-chunk">
              <CardBarChart2>
                <sdHeading as="h1">{{ agentData.total_revenue }}</sdHeading>
      ...
      <a-col :xxl="8" :lg="12" :md="24" :sm="12" :xs="24">
        <sdCards headless>
          <EChartCard>
            <div class="card-chunk">
              <CardBarChart2>
                <sdHeading as="h1">{{ agentData.redemption_points }}</sdHeading>
      ...
      <a-col :xxl="8" :lg="12" :md="24" :sm="12" :xs="24">
        <sdCards headless>
          <EChartCard>
            <div class="card-chunk">
              <CardBarChart2>
                <sdHeading as="h1"> {{ agentData.coupons_redeemed }}</sdHeading>
      ...
      <a-col :xs="24">
        <ProductOverviewTable>
          <sdCards more title="Products Sold">
            <template #more>
              <a to="#">
                <unicon name="print" width="16"></unicon>
                <span>Printer</span>
...
import { CardBarChart2, EChartCard, PerformanceChartWrapper, ChartContainer } from '@/view/adminView/dashboard/style';
