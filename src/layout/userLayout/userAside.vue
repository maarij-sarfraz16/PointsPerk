<template>
  ...
  >
    ...
    <a-menu-item @click="toggleCollapsed" key="redemptionhistory">
      ...
      <router-link to="/user/redemption-history"> Redemption History </router-link>
    </a-menu-item>
    ...
    <a-menu-item @click="toggleCollapsed" key="myperformance">
      ...
      <router-link to="/user/myperformance"> My Performance </router-link>
    </a-menu-item>
    ...
    <a-menu-item @click="toggleCollapsed" key="leaderboard">
      ...
      <router-link to="/user/leaderboard"> Leader Board </router-link>
    </a-menu-item>
