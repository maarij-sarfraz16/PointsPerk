    ...
    <a-col :xxl="6" :xl="12" :md="12" :sm="18">
      <AuthWrapper>
        ...
        <div class="ninjadash-authentication-content">
          ...
          <a-form @submit.prevent="handleSubmit" layout="vertical">
            ...
            <div class="ninjadash-auth-extra-links">
              ...
              <router-link class="forgot-pass-link" to="/user/forgotPassword"> Forgot password? </router-link>
            </div>
        ...
        <div class="ninjadash-authentication-bottom">
          <p>Don't have an account?<router-link to="/user/requestsignup">Sign up</router-link></p>
        </div>
      </AuthWrapper>
    </a-col>
  </a-row>
