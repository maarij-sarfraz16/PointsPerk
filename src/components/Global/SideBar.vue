  ...
  <v-navigation-drawer v-model="localDrawer">
    ...
    <div style=" display: flex; justify-content: center; align-items: center; height: 100px;">
      <v-list>
        ...
        <v-list-item link to="/">
          <v-list-item-icon><v-icon>mdi-account-multiple</v-icon>Users</v-list-item-icon>
        </v-list-item>

        <v-list-item link to="/">
          <v-list-item-icon> <v-icon>mdi-tools</v-icon>Tools </v-list-item-icon>
        </v-list-item>

        <v-list-item link to="/">
          <v-list-item-icon><v-icon>mdi-cog</v-icon>Settings</v-list-item-icon>
        </v-list-item>
      </v-list>
    </div>
