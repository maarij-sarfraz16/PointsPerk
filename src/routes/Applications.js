export default [
  ...
  },
  {
    ...
    name: "chat",
    component: () =>
      import(/* webpackChunkName: "chat" */ "../view/apps/chat/ChatApp.vue"),
    children: [
      {
        name: "private",
        path: "private",
  ...
  },
  {
    ...
    path: "/app/users",
    component: () =>
      import(/* webpackChunkName: "users" */ "../view/apps/users/Index.vue"),
    children: [
      {
        path: "dataTable",
        name: "dataTable",
        ...
        children: [
          {
            ...
            components: {
              ...
              descendant: () =>
                import(
                  /* webpackChunkName: "user-grid" */ "../view/apps/users/overview/UserCard.vue"
                ),
            },
          },
          {
    ...
    children: [
      {
        ...
        components: {
          ...
          child: () =>
            import(
              /* webpackChunkName: "note-all" */ "../view/apps/note/overview/all.vue"
            ),
        },
      },
      {
        ...
        components: {
          ...
          child: () =>
            import(
              /* webpackChunkName: "note-favorite" */ "../view/apps/note/overview/favorite.vue"
            ),
        },
      },
      {
        ...
        components: {
          ...
          child: () =>
            import(
              /* webpackChunkName: "note-personal" */ "../view/apps/note/overview/personal.vue"
            ),
        },
      },
      {
        ...
        components: {
          ...
          child: () =>
            import(
              /* webpackChunkName: "note-work" */ "../view/apps/note/overview/work.vue"
            ),
        },
      },
      {
  ...
  },
  {
    ...
    path: "/app/to-do",
    component: () =>
      import(/* webpackChunkName: "to-do" */ "../view/apps/todo/Todo.vue"),
  },
  {
    name: "import-export",
    path: "/app",
...

  {
    ...
    path: "/app/task",
    component: () =>
      import(/* webpackChunkName: "task" */ "../view/apps/task/Index.vue"),
    children: [
      {
        name: "all",
        path: "all",
  ...
  },
  {
    ...
    path: "/app/kanban",
    component: () =>
      import(/* webpackChunkName: "kanban" */ "../view/apps/kanban/Index.vue"),
  },
  {
    name: "tickets",
  ...
  },
  {
    ...
    component: () =>
      import(/* webpackChunkName: "course" */ "../view/apps/course/Course.vue"),
  },
  {
    name: "courseDetails",
